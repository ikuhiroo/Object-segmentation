...
"""
・pascal_vocで使用されている輝度値を取得する
・新しい画像に対して，segmentationClassを作成する
pepper →
背景 → 0
縁 → 220
"""
# pascolのSegmentationClassの場所
PASCOL_SEGMENTATION = Path("/Users/1-10robotics/Desktop/object_segmentation/models-master/research/deeplab/datasets/pepper/VOCdevkit/VOC2012/元データ/SegmentationClass")
PASCOL_Raw_SEGMENTATION = Path("/Users/1-10robotics/Desktop/object_segmentation/models-master/research/deeplab/datasets/pepper/VOCdevkit/VOC2012/元データ/SegmentationClassRaw")
NEW_SEGMENTATION = Path("/Users/1-10robotics/Desktop/new")
...
def main():
    ...
    # sess.run(init)
    # tf.train.start_queue_runners(sess)
    # fname = PASCOL_Raw_SEGMENTATION.iterdir()
    # for child in fname:
    #   print(child)
